...
switch($action){
  case "delete" :
    echo json_encode($admin->deleteProduct($id));  
     echo json_encode($id);
     die();
    break;
  case "edit" :
...
if ($_SESSION['admin'][0] == $email && $_SESSION['admin'][1] == $password) {
  ...
  echo "You do not have required permissions";
  exit();
}
...
<body>
  ...
  <script src="../assests/js/Products.js"  rel="text/javascript" ></script>
